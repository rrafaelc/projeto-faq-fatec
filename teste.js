...
questionsContainer.innerHTML += questions
  ...
  .join('');const form = document.querySelector('form');const hearts = document.querySelectorAll('#heart');
...
form.addEventListener('keyup', event => {  event.preventDefault();
  const searchValue = form.querySelector('input').value.toLowerCase();  containers.forEach(container => {
